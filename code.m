function simulation(thetalist, dthetalist, taulist, g, Ftip, Mlist, Glist, Slist, n)
...
%Ftip=[0;0;0;0;0;0];
%n=300;
%simulation(thetalist, dthetalist, taulist, g, Ftip, Mlist, Glist, Slist, n)
%Output: A .csv file named sim.csv will be created containing all the joint angles at each simulation step


t=0.01;% time step for simulation
 ddthetalist= ForwardDynamics(thetalist, dthetalist, taulist, ...
                                       g, Ftip, Mlist, Glist, Slist);
 MMM=thetalist';
 N=0;
 while N < n % n is the number of iterations for a simulation of 3 sec n=300
     thetalist=thetalist+(dthetalist*t);
     dthetalist=dthetalist+(ddthetalist*t);
      ddthetalist= ForwardDynamics(thetalist, dthetalist, taulist, ...
                                       g, Ftip, Mlist, Glist, Slist);                           
     N=N+1;
     MM=MMM;
     MMM=[MM;[thetalist]'];% to create a matrix of joint angles
 end
 csvwrite('sim.csv',MMM);% to save the MMM matrix as a .csv file
end
